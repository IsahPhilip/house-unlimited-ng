            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="font-bold text-gray-900">{settings.phone || "+234 904 375 2708"}</p>
                </div>
              </div>
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-12 h-12 bg-teal-50 text-teal-600 rounded-2xl flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="font-bold text-gray-900">
                    {settings.email || "official@houseunlimitednigeria.com"}
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-gray-900 text-sm">
                    {settings.address || "Suite S23 Febson Mall, Wuse Zone 4, Abuja 904101, Federal Capital Territory, Nigeria"}
                  </p>
                </div>
              </div>
            </div>
