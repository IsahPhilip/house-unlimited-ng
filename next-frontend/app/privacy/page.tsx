...
export default async function PrivacyPage() {
  ...
  const breadcrumbListSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Privacy", item: settings.siteUrl + "/privacy" },
    ],
  };

  return (
    <>
      <JsonLd data={breadcrumbListSchema} id="privacypage-breadcrumb-jsonld" />
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-sm max-w-2xl mx-auto">
            This policy explains how collects, uses, and protects personal information across our website and client touchpoints.
          </p>
        </div>
