        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-10 right-10 bg-white p-6 rounded-2xl shadow-xl z-20">
               <p className="text-[#005555] font-bold text-2xl">99%</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-[#005555] font-semibold mb-2 uppercase tracking-widest text-xs font-bold">Our Direction</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              return (
              <div key={idx} className="p-10 rounded-3xl bg-gray-50 border border-transparent hover:border-[#d8eeee] hover:bg-white hover:shadow-xl transition-all duration-300 group">
                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform text-[#005555]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, idx) => (
              <div key={member.slug || idx} className="group cursor-pointer">
                ...
                <p className="text-gray-500 text-xs font-bold uppercase tracking-widest mt-1">{member.role}</p>
              </div>
            ))}
          </div>
        </div>
        <div className="absolute top-0 right-0 w-1/3 h-full bg-[#005555]/5 -skew-x-12 translate-x-1/2"></div>
      </section>
    </div>
  );
}
