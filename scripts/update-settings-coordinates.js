#!/usr/bin/env node
// One-off script: fetch current settings.address from the headless REST API,
...
// Usage:
// HUN_WP_URL="https://your-wordpress.example.com" HUN_UPDATE_SECRET="mysecret" node scripts/update-settings-coordinates.js
// or
// node scripts/update-settings-coordinates.js --wp-url http://localhost/wordpress --secret mysecret
